...
export default function GoogleSignInButton({
  ...
  useEffect(() => {
    ...
    const render = () => {
      const google = (
        window as typeof window & { google?: { accounts: GoogleAccounts } }
      ).google;
    ...
    return (
      <div>
        <button
          ...
          onClick={() =>
            setMessage(
              "Add VITE_GOOGLE_CLIENT_ID in Vercel Environment Variables to activate Google OAuth.",
            )
          }
        ...
        >
          <span className="grid h-6 w-6 place-items-center rounded-full bg-[#4285F4] text-xs font-black text-white">
            G
          </span>
